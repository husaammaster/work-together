...
- `backend`: Node backend (exposes port 5100), runs `npm run dev` (overrides image CMD at runtime).
...
- **Legacy**: Static HTML/JS in `public/`, served by Express on port 5100.
